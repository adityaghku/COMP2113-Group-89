...
void displayInstructions(){
  cout << endl;
  cout << "Blackjack is a game where the player plays against the dealer, choosing their own bet amount to try and win as much money as possible against the casino." << endl;
  ...
  cout << "You can either [H]it or [S]tand on each turn. If you hit then you receive another card. If you stand, you do not want more cards and the round is over." << endl;
  cout << "You can also choose to [D]ouble. If you double, then you double your original bet, but can only receive one more card." << endl;
  ...
  cout << "After you stand, it is now the dealers turn. The dealer will hit until their score is 17 or higher, after which they will stand. The winner of the round is the individual with the score closest to 21, but not more than 21." << endl;
